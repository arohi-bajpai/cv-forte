...
const FEATURES = [
  {
    src: featureFreeSrc,
    title: "Free Forever",
    text: "CVForte is created with the belief that everyone should have free and easy access to a modern professional resume design",
  },
  {
    src: featureUSSrc,
    title: "U.S. Best Practices",
    text: "CVForte has built-in best practices for the U.S. job market and works well with top ATS platforms",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "CVForte stores data locally in your browser so only you have access to your data and with complete control",
  },
  {
    ...
    text: (
      <>
        CVForte is an open-source project, and its source code can be viewed
        by anyone on its{" "}
        <Link href="https://github.com/xitanggg/cv-forte">
          GitHub repository
        </Link>
      </>
    ),
