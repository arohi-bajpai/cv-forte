...
const RESUME_EXAMPLES = [
  ...
  {
    fileUrl: "resume-example/cvforte-resume.pdf",
    description: (
      <span>
        Created with CVForte resume builder -{" "}
        ...
        <div className="flex justify-center px-2 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:justify-end">
          <section className="mt-5 grow px-4 md:max-w-[600px] md:px-0">
            <div className="aspect-h-[9.5] aspect-w-7">
              <iframe title="PDFDisplay" src={`${fileUrl}#navpanes=0`} className="h-full w-full" />
            </div>
          </section>
        ...
        <div className="flex px-6 text-gray-900 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
          ...
          <section className="max-w-[600px] grow">
            ...
            <Paragraph smallMarginTop={true}>
              This playground showcases the CVForte resume parser and its
